  ...
  methods: {
    submitForm() {
      ...
      if (this.cardID === 0) {
        ...
        // if we weren't going to another page on success. we wpould
        // want to clear out error so message reflects current call
        // (no error if it succeeds or new error if it occurs)
        // this.errorMsg = ''
        boardsService
          .addCard(newCard)
          .then(response => {
