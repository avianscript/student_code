...
//
//
//        int [] array2 = { 2, 67, 3, 3565, 356, 345, 23};
//        printInts(array2);
...
//        System.out.println("lastElement: " + lastElement);
        ...
        int [] otherNum =  { 2, 67, 3, 3565, 356, 345, 23};
//
        int firstNumElement = returnFirstElementOfParam(nums);
        System.out.println("firstNumElement: " + firstNumElement);

        int otherFirstELenemts = returnFirstElementOfParam(otherNum);
        System.out.println(otherFirstELenemts);

        int lastNumElement = returnLastElementOfParam(nums);
        System.out.println("lastNumElement: " + lastNumElement);

        int otherLastELenemts = returnLastElementOfParam(otherNum);
        System.out.println(otherLastELenemts);
