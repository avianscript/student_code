...
public class HotelController {
    ...
    public Reservation updateReservation(@RequestBody @Valid Reservation updateReservation, @PathVariable Integer id) throws ReservationNotFoundException {
        return reservationDao.update(updateReservation, id);
    }
