...
SELECT city_name FROM city WHERE state_abbreviation = 'DE'
...
-- The names, areas, populations, and state abbreviation of cities in California (CA) or Florida (FL)
SELECT city_name, area, population, state_abbreviation FROM city WHERE state_abbreviation = 'CA' 
OR state_abbreviation = 'FL'


-- The names, areas, populations, and state abbreviation of cities in New England -- Connecticut (CT), Maine (ME), Massachusetts (MA), New Hampshire (NH), Rhode Island (RI) and Vermont (VT)
