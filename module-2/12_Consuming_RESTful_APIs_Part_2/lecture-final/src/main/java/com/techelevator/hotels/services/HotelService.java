...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        ...
        try {
            Reservation savedReservation = restTemplate.postForObject(url, entity, Reservation.class);
            return savedReservation;
        } catch (RestClientResponseException ex) {
            BasicLogger.log("Error adding reservation: " + ex.getRawStatusCode() + " " + ex.getStatusText());
